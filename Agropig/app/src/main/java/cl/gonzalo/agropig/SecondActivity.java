...
public class SecondActivity extends AppCompatActivity {
    ...
    private String url = "http://172.20.10.5:8000/api/registrar";
    private Context ctx;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Lista de Codigos");
        ...
        arrayAdapter = new ArrayAdapter(SecondActivity.this, android.R.layout.simple_list_item_1, arrayList);
                ...
                builder.setTitle("Eliminar codigo")
                        ...
                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                Toast.makeText(SecondActivity.this, "Se eliminó el codigo "+arrayList.get(position).toString(),Toast.LENGTH_SHORT).show();
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (arrayList.size() == 0){
                    Toast.makeText(SecondActivity.this, "Debe registrar al menos un Animal",Toast.LENGTH_SHORT).show();
                } else {
                    int elementos = arrayAdapter.getCount();
                    AlertDialog.Builder builder;
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    builder.setTitle("Registro de Codigos")
                            .setMessage("¿Registrar " + elementos + " nuevos animales?")
                            .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    int i;
                                        ...
                                        strq = new StringRequest(Request.Method.POST, url,
                                                new Response.Listener<String>() {
                                                    ...
                                                    public void onResponse(String response) {
                                                        ...
                                                        Toast.makeText(ctx, "Codigo " + response + " registrado", Toast.LENGTH_SHORT).show();
                                                    }
                                            ...
                                            public void onErrorResponse(VolleyError error) {
                                                ...
                                                if(error instanceof ClientError){
                                                    Toast.makeText(SecondActivity.this, "Codigo existente", Toast.LENGTH_SHORT).show();
                                                } else if(error instanceof TimeoutError){
                                                    Toast.makeText(SecondActivity.this, "Error de conexion con servidor, reintente", Toast.LENGTH_SHORT).show();
                                                } else if(error instanceof ServerError){
                                                    Toast.makeText(SecondActivity.this, "Error de conexion con servidor, reintente", Toast.LENGTH_SHORT).show();
                                                } else if(error instanceof NoConnectionError){
                                                    Toast.makeText(SecondActivity.this, "Error de conexion con servidor", Toast.LENGTH_SHORT).show();
                                                }
                                                //
                                            }
                                        }) {
                                    ...
                                    startActivity(new Intent(SecondActivity.this, Principal.class));
                                    finish();
                                }
                            })
                            .setNegativeButton(android.R.string.no, new DialogInterface.OnClickListener() {
        ...
        if(result != null)  {
            if(result.getContents() == null) {
                ...
                if (resultado.length() != 10){
                    Toast.makeText(SecondActivity.this, "Error, Tamaño de caracteres incorrecto", Toast.LENGTH_LONG).show();
                } else {
                    if (resultado.substring(0, 2).equals("ch")) {
                        if (!arrayList.contains(resultado)){
                            ...
                            Toast.makeText(SecondActivity.this, "Error, codigo repetido", Toast.LENGTH_LONG).show();
                        }

                    } else {
                        Toast.makeText(SecondActivity.this, "Error, codigo invalido", Toast.LENGTH_LONG).show();
                    }
                }
            }
        } else {
